...
SRC_URI += "file://0001-Don-t-try-to-import-numpy-native-during-setup.patch"
...
DEPENDS += "python3 python3-cython-native geos python3-numpy python3-numpy-native"
RDEPENDS:${PN} += "python3-core python3-numpy"

export NUMPY_INCLUDE_PATH = "${RECIPE_SYSROOT}${PYTHON_SITEPACKAGES_DIR}/numpy/_core/include"
