...
#DEPENDS += "python3-astunparse python3-numpy ninja cmake python3-cffi python3-typing-extensions python3-future python3-six python3-requests python3-dataclasses"

# optional: fftw, hiredis, opencv
...
RDEPENDS:${PN} += "python3-astunparse python3-asyncio python3-audio python3-boto3 python3-botocore python3-compression python3-core python3-crypt python3-ctypes python3-dataclasses python3-datetime python3-debugger python3-difflib python3-distutils python3-hypothesis python3-io python3-json python3-logging python3-math python3-matplotlib python3-misc python3-multiprocessing python3-netclient python3-numbers python3-numpy python3-packaging python3-pickle python3-pillow python3-pkg-resources python3-pprint python3-profile python3-psutil python3-setuptools python3-shell python3-six python3-sqlite3 python3-statistics python3-stringold python3-tensorrt python3-threading python3-typing-extensions python3-unittest python3-urllib3 python3-xml"
